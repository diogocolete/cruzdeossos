...
@section('content')
  ...
  <header class="header" id="header">
    <div class="container header__inner">
      ...
      @if($secoes['sec_junte_se'] ?? true)<a href="#join" class="btn btn--primary header__cta">Junte-se ao Clube</a>@endif
  ...
  <footer class="footer">
    <div class="container footer__top">
      ...
      <div class="footer__col">
        <h4>O Clube</h4>
        <ul>
          @if($secoes['sec_por_que_nos'] ?? true)<li><a href="#why">Nossa Missão</a></li>@endif
          @if($secoes['sec_noticias'] ?? true)<li><a href="#news">Notícias</a></li>@endif
          @if($secoes['sec_junte_se'] ?? true)<li><a href="#join">Junte-se</a></li>@endif
          @if($secoes['sec_eventos'] ?? true)<li><a href="#events">Eventos</a></li>@endif
        </ul>
      </div>
      <div class="footer__col">
